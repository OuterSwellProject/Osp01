...
// in simulator we redefine to format for osp01 Developer console
...
{\
	NSString * exceptionName = [@"org.osp01." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.osp01";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIosp01NativeItemNone = -1, 
	UIosp01NativeItemSpinner = -2,
	UIosp01NativeItemProgressBar = -3,
	
	UIosp01NativeItemSlider = -4,
	UIosp01NativeItemSwitch = -5,
	UIosp01NativeItemMultiButton = -6,
	UIosp01NativeItemSegmented = -7,
	
	UIosp01NativeItemTextView = -8,
	UIosp01NativeItemTextField = -9,
	UIosp01NativeItemSearchBar = -10,
	
	UIosp01NativeItemPicker = -11,
	UIosp01NativeItemDatePicker = -12,
	
	UIosp01NativeItemInfoLight = -13,
	UIosp01NativeItemInfoDark = -14,
	
	UIosp01NativeItemDisclosure = -15,
	
	UIosp01NativeItemContactAdd = -16
};
