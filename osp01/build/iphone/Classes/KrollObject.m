 ...
 * Copyright (c) 2009-2011 by osp01, Inc. All Rights Reserved.
...
//@interface osp01Object : NSObject
//@end

@interface osp01Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[osp01Object class]])
		{
			for (NSString *key in [[(osp01Object*)o modules] allKeys])
			{
